...
public record ExpressiveScheme(HCTA Source, bool IsDark, double ContrastLevel = 0)
    : DynamicScheme(Source, Variant.Expressive, ContrastLevel, IsDark,
        Primary: new TonalPalette(Color.SanitizeDegrees(Source.H + 240), 40),
        ...
        Neutral: new TonalPalette(Color.SanitizeDegrees(Source.H + 15), 8),
        NeutralVariant: new TonalPalette(Color.SanitizeDegrees(Source.H + 15), 12))
{
